...
export const projectMeta: Record<string, ProjectMeta> = {
  ...
  "casa-liebre": { uso: "Comercial", servicio: COMERCIAL, ubicacion: "San Pedro Garza García, N.L." },
  nailz: { uso: "Comercial", servicio: COMERCIAL, ubicacion: "San Pedro Garza García, N.L." },
  "crispy-pollo": { uso: "Comercial", servicio: COMERCIAL, ubicacion: "Puerto Vallarta, Jal." },
  ...
  "tp-zentralia": { uso: "Corporativo", servicio: CORPORATIVO, ubicacion: "Ciudad de México" },
  "edificio-vh": { uso: "Corporativo", servicio: CORPORATIVO, ubicacion: "Monterrey, N.L." },
